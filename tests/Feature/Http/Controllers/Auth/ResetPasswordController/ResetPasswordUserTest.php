...
class ResetPasswordUserTest extends UserTestCase
{
    ...
    public function testResetPasswordAfterFormFilled(): void
    {
        ...
        $userNew = TestUserModel::where('email', 'john@example.com')->first();
    ...
    public function testDoNotResetPasswordIfEmailAndTokenDoesNotMatch(): void
    {
        ...
        $userNew2 = TestUserModel::where('email', 'john2@example.com')->first();
        ...
        $userNew1 = TestUserModel::where('email', 'john@example.com')->first();
